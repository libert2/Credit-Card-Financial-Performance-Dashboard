...
COPY cc_detail
FROM 'D:\PowerBi dashboard project\Credit_Card_Financial_Dashboard-main\Credit_Card_Financial_Dashboard-main\credit_card.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'D:\PowerBi dashboard project\Credit_Card_Financial_Dashboard-main\Credit_Card_Financial_Dashboard-main\customer.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'D:\PowerBi dashboard project\Credit_Card_Financial_Dashboard-main\Credit_Card_Financial_Dashboard-main\cc_add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'D:\PowerBi dashboard project\Credit_Card_Financial_Dashboard-main\Credit_Card_Financial_Dashboard-main\cust_add.csv' 
DELIMITER ',' 
CSV HEADER;
